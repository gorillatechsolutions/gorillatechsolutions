  ...
  return (
    <footer className="w-full border-t bg-card text-card-foreground">
      ...
      <div className="border-t py-2" style={{ backgroundColor: '#243878' }}>
        <div className="flex flex-col sm:flex-row justify-between items-center px-4 sm:px-6 lg:px-8 text-sm text-white/80 gap-4 py-2">
          <p>&copy; {new Date().getFullYear()} Gorilla Tech Solutions. All rights reserved.</p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <div className="flex flex-col items-center">
                <Button asChild size="sm" className="bg-white text-black hover:bg-gray-200 shadow-lg transition-transform transform hover:scale-105 text-xs h-auto py-1 px-3">
                    <Link href="#" className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                            <span className="font-bold text-lg" style={{color: '#0082fb'}}>Meta Business</span>
                            <span className="text-sm -mt-1" style={{color: 'limegreen'}}>Verified Partner</span>
                        </div>
                    </Link>
                </Button>
            </div>
