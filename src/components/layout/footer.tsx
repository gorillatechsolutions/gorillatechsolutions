          ...
          <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-2">
            ...
            <Link href="#" className="hover:underline flex items-center gap-2">
                <svg
                    ...
                    <path
                        d="M26.237 36.315c9.24-2.22 14.54-11.233 12.32-20.473-2.22-9.24-11.233-14.54-20.473-12.32-9.24 2.22-14.54 11.233-12.32 20.473 2.22 9.24 11.233 14.54 20.473 12.32zm-5.75-20.088c-.628-.18-1.07-.723-1.07-1.393v-3.41c0-.78.59-1.41 1.36-1.41h2.53c.77 0 1.36.63 1.36 1.41v3.41c0 .67-.442 1.213-1.07 1.393l-1.065 1.76c-.23.38-.802.38-.992 0l-1.015-1.76zm-3.322 2.88c-.352-.303-.52-.752-.46-1.192l.74-4.88c.11-1.062.97-1.85 2.04-1.85h3.61c1.07 0 1.93.788 2.04 1.85l.74 4.88c.06.44-.108.89-.46 1.192l-4.125 3.51c-.34.29-.85.29-1.125 0l-4.125-3.51z"
                        fill="#FF9900"
                    />
                    <path
                        d="M39.467 43.766c.21 1.27-1.27 2.09-2.3 1.42l-10.43-6.84c-.38-.25-.89-.25-1.27 0l-10.36 6.84c-1.03.67-2.51-.15-2.3-1.42l4.82-12.19c.17-.42-.02-.89-.43-1.12l-9.82-5.5a1.53 1.53 0 01-.6-2.12c.45-.88 1.6-.96 2.47-.23l8.6 7.32c.36.3.84.3 1.2 0l8.6-7.32c.87-.73 2.02-.65 2.47.23.4.78.1 1.74-.6 2.12l-9.83 5.5c-.4.23-.6.7-.42 1.12l4.82 12.19z"
                        fill="#232F3E"
                    />
                    </g>
                </svg>
