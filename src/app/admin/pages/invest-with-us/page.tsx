...
export default function InvestmentSettingsPage() {
    const { content, updateContent, loading } = useInvestmentPage();
    ...
    const onSubmit = (values: z.infer<typeof formSchema>) => {
        ...
        toast({
            title: 'Investment Page Saved!',
            description: 'Your changes to the "Invest with Us" page have been saved.',
        });
    };
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-2xl font-bold text-foreground">Edit "Invest with Us" Page</h1>
                <p className="text-muted-foreground">Update the content displayed on your public investor inquiry page.</p>
            </div>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                     <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <FormField control={form.control} name="metaKeywords" render={({ field }) => (<FormItem><FormLabel>Meta Keywords</FormLabel><FormControl><Textarea {...field} placeholder="e.g., invest in digital marketing, tech investment" /></FormControl><FormDescription>Enter keywords separated by commas.</FormDescription><FormMessage /></FormItem>)} />
