...
export default function AppsSettingsPage() {
    const { content, updateContent, loading } = useAppsPage();
    ...
    const onSubmit = (values: z.infer<typeof formSchema>) => {
        ...
        toast({
            title: 'Apps Page Saved!',
            description: 'Your changes to the apps page have been saved.',
        });
    };
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-2xl font-bold text-foreground">Edit Apps Page</h1>
                <p className="text-muted-foreground">Update the content displayed on your public "Our Apps" listing page.</p>
            </div>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                     <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <FormField control={form.control} name="metaKeywords" render={({ field }) => (<FormItem><FormLabel>Meta Keywords</FormLabel><FormControl><Textarea {...field} placeholder="e.g., business apps, productivity tools" /></FormControl><FormDescription>Enter keywords separated by commas.</FormDescription><FormMessage /></FormItem>)} />
