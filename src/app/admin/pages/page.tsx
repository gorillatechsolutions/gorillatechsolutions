    ...
    <div className="space-y-6">
      ...
      <Card>
          <CardHeader>
              ...
              <CardDescription>A list of all editable pages on your website.</CardDescription>
          </CardHeader>
          <CardContent>
              <Table>
                  <TableHeader>
                          ...
                          <TableRow key={link.href}>
                              <TableCell className="font-medium">
                                  <div className="flex items-center gap-3">
                                      <FontAwesomeIcon icon={link.icon} className="h-4 w-4 text-muted-foreground" />
                                      <span>{link.title}</span>
                                  </div>
                              </TableCell>
                              <TableCell className="text-muted-foreground max-w-sm truncate">{link.description}</TableCell>
                              <TableCell className="text-right">
                                <div className="flex justify-end gap-2">
                                  ...
                                  <Button asChild size="xs">
                                      <Link href={link.href}>
                                          Edit <FontAwesomeIcon icon={faArrowRight} className="ml-2 h-3 w-3" />
                                      </Link>
                                  </Button>
                                </div>
                              </TableCell>
