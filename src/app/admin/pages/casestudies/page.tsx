...
export default function CaseStudiesSettingsPage() {
    const { content, updateContent, loading } = useCaseStudiesPage();
    ...
    const onSubmit = (values: z.infer<typeof formSchema>) => {
        ...
        toast({
            title: 'Case Studies Page Saved!',
            description: 'Your changes to the case studies page have been saved.',
        });
    };
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-2xl font-bold text-foreground">Edit Case Studies Page</h1>
                <p className="text-muted-foreground">Update the content displayed on your public "Case Studies" listing page.</p>
            </div>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                     <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <FormField control={form.control} name="metaKeywords" render={({ field }) => (<FormItem><FormLabel>Meta Keywords</FormLabel><FormControl><Textarea {...field} placeholder="e.g., digital marketing case studies, seo results" /></FormControl><FormDescription>Enter keywords separated by commas.</FormDescription><FormMessage /></FormItem>)} />
