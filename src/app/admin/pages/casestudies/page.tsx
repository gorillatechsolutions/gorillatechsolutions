                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                     <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <FormField control={form.control} name="metaKeywords" render={({ field }) => (<FormItem><FormLabel>Meta Keywords</FormLabel><FormControl><Input {...field} placeholder="e.g., digital marketing case studies, seo results" /></FormControl><FormDescription>Enter keywords separated by commas.</FormDescription><FormMessage /></FormItem>)} />
