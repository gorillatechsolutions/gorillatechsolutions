...
import { faTachometerAlt, faUsers, faCog, faChartLine, faSignOutAlt, faPenToSquare, faMobileScreenButton, faConciergeBell } from '@fortawesome/free-solid-svg-icons';
