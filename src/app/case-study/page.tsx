...
import { ArrowRight, CalendarDays, UserCircle, Search } from 'lucide-react';
import type { Metadata } from 'next';
import Image from 'next/image';
import Link from 'next/link';

// Metadata can still be defined in client components, but it won't be statically analyzed at build time.
// For static metadata, consider moving it to a layout or keeping this a server component and passing data to a client child component.
// However, for this interactive page, this is a common approach.
