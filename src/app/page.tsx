...
export default function Home() {
  return (
    <div className="w-full">
      <section className="relative flex items-center justify-center w-full h-[calc(100vh-4rem)] min-h-[500px] md:h-[90vh] bg-background">
        <div className="absolute inset-0 bg-grid-pattern opacity-10" style={{'--stroke': 'hsl(var(--border))'}}></div>
        <div className="container relative px-4 md:px-6 text-center animate-fade-in-up">
